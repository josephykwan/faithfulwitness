 ...
 *
 * WHAT THIS PAGE DOES:
 *   Displays a filterable library of resources pulled automatically from the
 *   "fw_resource" post type. Filters by Resource Type, Issue Area, and Audience.
 *   Also shows a "Start Here" featured section (resources with fw_resource_featured=1)
 *   and Campaign Packs grouped by initiative.
 *
 * HOW TO MANAGE CONTENT (no code editing required):
 *   - Add resources: Faithful Witness → + Add a Resource
 *   - Feature a resource: check "Feature this resource" in the Resource Details box
 *   - Link a resource to a campaign pack: select a Related Initiative in the Resource Details box
 *   - Edit filter labels: edit taxonomy terms under Resources → Resource Types / Issue Areas / Audiences
 *
 * DO NOT EDIT THIS FILE to change content. All content is managed through the admin.
 * Only edit this file if you need to change the page layout or structure.
 */
