 ...
 *
 * WHAT THIS PAGE DOES:
 *   Displays a monthly calendar grid + list view toggle for all events in the
 *   "fw_event" post type. Filter pills come from the fw_event_category taxonomy.
 *   A mini widget showing the next 3 upcoming events also appears on the homepage.
 *
 * HOW TO MANAGE CONTENT (no code editing required):
 *   - Add events: Faithful Witness → + Add an Event
 *   - Set start date, time, location, virtual link, registration link in Event Details
 *   - Assign an event category (Prayer Gathering, KYR Training, Webinar, etc.) in the sidebar
 *   - Events automatically appear on the calendar for the correct month
 *   - Past events remain visible on the calendar but are hidden from the homepage widget
 *
