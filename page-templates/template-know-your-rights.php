...
// Page-level ACF fields — edit via Pages → Know Your Rights → edit
$hero_eyebrow  = get_field( 'fw_page_hero_eyebrow' )  ?: __( 'Practical Information', 'faithfulwitness' );
$hero_title    = get_field( 'fw_page_hero_title' )    ?: __( 'Know Your Rights', 'faithfulwitness' );
$hero_subtitle = get_field( 'fw_page_hero_subtitle' ) ?: __( 'Practical legal information for immigrants and the faith communities that walk with them.', 'faithfulwitness' );
?>
...
<section class="kyr-quick-section section" id="quick-access">
    <div class="container">
        ...
        <!-- Download All CTA -->
        <?php $kyr_download_url = get_field( 'fw_kyr_download_all_url' ) ?: get_theme_mod( 'fw_kyr_download_all_url', '#' ); ?>
        <div style="text-align:center;margin-top:var(--space-10);">
            <a href="<?php echo esc_url( $kyr_download_url ); ?>"
...
<section class="section section--alt" id="ice-at-door">
    <div class="container container--narrow">
        ...
        <div class="entry-content">
            <?php
            $content = get_field( 'fw_kyr_ice_content' ) ?: get_theme_mod( 'fw_kyr_ice_content', '' );
            if ( $content ) {
                echo wp_kses_post( $content );
            } else : ?>
            <p><?php esc_html_e( 'Edit this section via Pages → Know Your Rights → edit, in the "Know Your Rights — Page Content" box.', 'faithfulwitness' ); ?></p>
            <ul>
...
<section class="section" id="detained">
    <div class="container container--narrow">
        ...
        <div class="entry-content">
            <?php
            $content = get_field( 'fw_kyr_detained_content' ) ?: get_theme_mod( 'fw_kyr_detained_content', '' );
            if ( $content ) {
                echo wp_kses_post( $content );
            } else : ?>
            <p><?php esc_html_e( 'Edit this section via Pages → Know Your Rights → edit, in the "Know Your Rights — Page Content" box.', 'faithfulwitness' ); ?></p>
...
<section class="section section--alt" id="congregations">
    <div class="container container--narrow">
        ...
        <div class="entry-content">
            <?php
            $content = get_field( 'fw_kyr_sanctuary_content' ) ?: get_theme_mod( 'fw_kyr_sanctuary_content', '' );
            if ( $content ) {
                echo wp_kses_post( $content );
            } else : ?>
            <p><?php esc_html_e( 'Edit this section via Pages → Know Your Rights → edit, in the "Know Your Rights — Page Content" box.', 'faithfulwitness' ); ?></p>
