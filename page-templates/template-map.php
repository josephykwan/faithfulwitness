 ...
 *
 * WHAT THIS PAGE DOES:
 *   A standalone full-screen map view of all organizing groups.
 *   Sidebar shows a filterable list; selecting a group pans the map.
 *   This is an alternative/supplementary view to the Find Your Network page.
 *
 * HOW TO MANAGE CONTENT (no code editing required):
 *   Same as Find Your Network — add/edit partners via Faithful Witness → Network Partners.
 *   Latitude + Longitude must be filled in for a pin to appear on the map.
 *
 * NOTE: The primary network page is /network (template-network.php).
 * This template is an alternate map-only view. Consider whether both are needed.
 *
 * DO NOT EDIT THIS FILE to change partner content. Only edit for layout/structural changes.
 */
