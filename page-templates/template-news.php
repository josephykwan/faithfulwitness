...
// Page-level ACF fields — edit via Pages → News & Media → edit
$hero_eyebrow  = get_field( 'fw_page_hero_eyebrow' )  ?: __( 'In the Public Square', 'faithfulwitness' );
$hero_title    = get_field( 'fw_page_hero_title' )    ?: __( 'Faithful Witness in the News', 'faithfulwitness' );
$hero_subtitle = get_field( 'fw_page_hero_subtitle' ) ?: __( 'Coverage, statements, and press resources from the Faithful Witness campaign.', 'faithfulwitness' );
?>
